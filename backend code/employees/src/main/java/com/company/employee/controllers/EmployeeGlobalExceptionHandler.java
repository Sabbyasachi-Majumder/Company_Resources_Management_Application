...
public class EmployeeGlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleServletException(ServletException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto("", "Internal server error: " + ex.getMessage())));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleJwtException(JwtException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto("INVALID_TOKEN", message)));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto("BAD_REQUEST", errorMessage.toString())));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleAuthenticationException(AuthenticationException ex, HttpServletRequest request) {
        String message;
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleAccessDeniedException(AccessDeniedException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleTransactionSystemException(TransactionSystemException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleIllegalArgumentException(IllegalArgumentException ex, Pageable pageable, HttpServletRequest request) {
        logger.error("IllegalArgumentException : {} - Path: {} - StackTrace: ", ex.getMessage(), request.getRequestURI(), ex);
        if (pageable.getPageNumber() <= 0)
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ApiResponseDTO<>(new ErrorDetailsDto(null, "Total number of records is lower than 1.")));
        else
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .contentType(MediaType.APPLICATION_JSON)
                    .body(new ApiResponseDTO<>(new ErrorDetailsDto("BAD_REQUEST", "Current page " + (pageable.getPageNumber()) + " is bigger than total number of pages available.")));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleGenericException(Exception ex, HttpServletRequest request) {
        logger.error("Unexpected error: {} - Path: {} - StackTrace: ", ex.getMessage(), request.getRequestURI(), ex);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto(null, "Generic Internal server error: " + ex.getMessage())));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleNoSuchElementException(NoSuchElementException ex) {
        logger.error("Resource not found: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto(null, "Resource not found: " + ex.getMessage())));
    }

    // Per Item Failure – these can be mapped to positive employeeId keys in operationDetails
    @ExceptionHandler(EntityNotFoundException.class)
    @Schema(description = "Requested resource/employee not found. In bulk operations, this is a per-item failure (positive employeeId key).")
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleEntityNotFoundException(EntityNotFoundException ex) {
        logger.error("Resource not found: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ApiResponseDTO<>(new ErrorDetailsDto(null, "Resource not found: " + ex.getMessage())));
    }
    ...
    public ResponseEntity<ApiResponseDTO<ErrorDetailsDto>> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {

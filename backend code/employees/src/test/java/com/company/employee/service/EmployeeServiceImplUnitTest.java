...
//    private EmployeeDTO employeeFetchOrCreateRequest;
...
//        ArrayList<EmployeeDTO> employees = new ArrayList<>(List.of(employeeFetchOrCreateRequest));
...
//        ArrayList<EmployeeDTO> employees = new ArrayList<>(List.of(employeeFetchOrCreateRequest, existingEmployee));
//        ApiResponseDTO<EmployeeResponseDTO> response = employeeService.addDataToDataBase(employees);
//
//        // Assert: Verify response
//        assertNotNull(response, "Response should not be null");
...
//        ArrayList<EmployeeDTO> employees = new ArrayList<>(List.of(employeeFetchOrCreateRequest, nonExistentEmployee));
//        ApiResponseDTO<EmployeeResponseDTO> response = employeeService.updateDataToDataBase(employees);
//
//        // Assert: Verify response
//        assertNotNull(response, "Response should not be null");

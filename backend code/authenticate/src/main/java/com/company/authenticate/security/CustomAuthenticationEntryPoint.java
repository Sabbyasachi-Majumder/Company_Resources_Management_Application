...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException {
        ...
        if (path.startsWith("/swagger-ui/") || path.equals("/swagger-ui.html") || path.startsWith("/v3/api-docs/") || path.equals("/api/v1/authenticates/authenticate") ||  path.equals("/api/v1/authenticates/testConnection") || path.equals("/api/v1/authenticates/testDataBaseConnection")) {

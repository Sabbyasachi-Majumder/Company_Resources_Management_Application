...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .addServersItem(new Server().url("http://localhost:8084").description("Local Development Server"))
                .addServersItem(new Server().url("/department").description("API Gateway Route for Microservices"))
                .info(new Info()
                        .title("department Service API")
                        .description("API for managing department data in a microservices architecture with JWT-based authentication")
                        .version("1.0.0")
                ...
                .addTagsItem(new Tag().name("Department Management").description("Endpoints for managing department data"));
    }
}
